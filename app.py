...
footer_css = """
<style>
/* Ensure body and app container take full height */
...
/* Make Streamlit's main content use flexbox */
[data-testid="stApp"] {
    display: flex;
...
/* Push content up and footer down */
.main {
...
<div class="custom-footer">
    <p>© 2025 Pratham Mohan | All rights reserved. Licensed under MIT License.</p>
    <p>
        <a href="https://github.com/paratha14" target="_blank">GitHub</a> •
        <a href="https://www.linkedin.com/in/pratham-mohan-47013b2b5/?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank">LinkedIn</a> •
        <a href="https://x.com/parathaOp" target="_blank">Twitter</a> •
        <a href="pmoff1719@gmail.com">Contact</a>
    </p>
</div>
"""
